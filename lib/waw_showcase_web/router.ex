defmodule WawShowcaseWeb.Router do
  use WawShowcaseWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {WawShowcaseWeb.Layouts, :root}
  ...
  # scope "/api", WawShowcaseWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:waw_showcase, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: WawShowcaseWeb.Telemetry
