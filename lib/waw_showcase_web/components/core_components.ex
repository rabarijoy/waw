defmodule WawShowcaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WawShowcaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WawShowcaseWeb.Gettext, "errors", msg, opts)
    end
  end
